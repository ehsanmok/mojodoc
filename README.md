...
- [envo](https://ehsanmok.github.io/envo/) — Typed environment variable loader
- [morph](https://ehsanmok.github.io/morph/) — Type-safe serialization framework
- [sqlite](https://ehsanmok.github.io/sqlite/) — SQLite library with ORM support
- [tempo](https://ehsanmok.github.io/tempo/) — Date, time, and duration library
- [uuid](https://ehsanmok.github.io/uuid/) — UUID generation and parsing
- [flare](https://ehsanmok.github.io/flare/) — Networking library (TCP, UDP, TLS, HTTP, WebSocket)
- [mozz](https://ehsanmok.github.io/mozz/) — Low-level networking primitives
- [pprint](https://ehsanmok.github.io/pprint/) — Reflection-driven pretty printer
- [json](https://ehsanmok.github.io/json/) — High-performance JSON library
